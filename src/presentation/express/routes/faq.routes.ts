...
router.route('/').post(authenticateRequest, routesHandler(createFaqController)).get(routesHandler(findFaqsController))

router.route('/bulk').delete(authenticateRequest, routesHandler(deleteFaqsController))

router.route('/:id').put(authenticateRequest, routesHandler(updateFaqController)).delete(authenticateRequest, routesHandler(deleteFaqController)).get(routesHandler(findFaqController))
