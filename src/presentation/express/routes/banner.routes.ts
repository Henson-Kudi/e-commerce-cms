...
router.route('/').post(authenticateRequest, routesHandler(createBannerController)).get(routesHandler(findBannersController))

router.route('/bulk').delete(authenticateRequest, routesHandler(deleteBannersController))

router.route('/:id').put(authenticateRequest, routesHandler(updateBannerController)).delete(authenticateRequest, routesHandler(deleteBannerController)).get(routesHandler(findBannerController))
