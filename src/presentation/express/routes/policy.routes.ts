...
router
  .route('/')
  .post(authenticateRequest, routesHandler(createPolicyController))
  .get(routesHandler(findPoliciesController));

router
  .route('/bulk')
  .delete(authenticateRequest, routesHandler(deletePoliciesController));

router
  .route('/:id')
  .put(authenticateRequest, routesHandler(updatePolicyController))
  .delete(authenticateRequest, routesHandler(deletePolicyController))
  .get(routesHandler(findPolicyController));
