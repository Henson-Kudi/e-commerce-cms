...
export default class FindPoliciesController implements IContoller<ReturnValueWithPagination<PrivacyPolicy[]>> {
    constructor(private readonly service: PolicyService) { }

    handle(request: RequestObject): Promise<ReturnValueWithPagination<PrivacyPolicy[]>> {
