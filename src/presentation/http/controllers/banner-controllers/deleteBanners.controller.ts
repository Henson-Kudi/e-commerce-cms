...
export default class DeleteBannersController implements IContoller<ReturnValue<Prisma.BatchPayload>> {
...
export const deleteBannersController = new DeleteBannersController(bannersService);
