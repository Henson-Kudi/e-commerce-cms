...
export default class CreateBannerController implements IContoller<ReturnValue<Banner>> {
...
export const createBannerController = new CreateBannerController(bannersService);