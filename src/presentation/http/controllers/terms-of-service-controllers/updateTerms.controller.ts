...
export default class UpdateTermsController implements IContoller<ReturnValue<TermsOfService | null>> {
    constructor(private readonly service: TermsService) { }

    async handle(request: RequestObject): Promise<ReturnValue<TermsOfService | null>> {
...
export const updateTermsController = new UpdateTermsController(termsOfServiceService)