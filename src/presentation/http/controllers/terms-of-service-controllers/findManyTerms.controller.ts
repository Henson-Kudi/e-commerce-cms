...
export default class FindManyTermsController
  implements IContoller<ReturnValueWithPagination<TermsOfService[]>>
{
...
export const findManyTermsController = new FindManyTermsController(
  termsOfServiceService
);
