...
export default class CreateTermsOfServiceController
  implements IContoller<ReturnValue<TermsOfService>>
{
...
export const createTermsOfServiceController =
  new CreateTermsOfServiceController(termsOfServiceService);
