...
export default class DeleteTermsController implements IContoller<ReturnValue<TermsOfService | null>> {
...
export const deleteTermsController = new DeleteTermsController(termsOfServiceService)