...
export default class TermsOfServiceRepository
  implements ITermsOfServicePostRepository
{
  constructor(
    private readonly dataSource: Prisma.TermsOfServiceDelegate<DefaultArgs>
  ) {}
