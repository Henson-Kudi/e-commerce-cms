...
import { IFindTermsAndConditionsDTO, IFindTermsAndConditionsOptions } from '../../../domain/dtos/termsAndConditions';
...
export default class FindManyTermsOfService
  ...
  async execute(
    ...[query, options]: [IFindTermsAndConditionsDTO, IFindTermsAndConditionsOptions]
